...
async def registro_paso2(
    ...
    AuthService.complete_registration_step2(
        db,
        token=body.token,
        password=body.password,
        payment_tipo=body.paymentTipo,
        payment_datos=body.paymentDatos,
        payment_moneda=body.paymentMoneda,
        payment_limite=body.paymentLimite,
        payment_pais=body.paymentPais,
    )
