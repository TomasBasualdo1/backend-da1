...
class TestSubastaPagoApi(unittest.TestCase):
    ...
    def test_admin_puede_cerrar_item_activo_y_generar_pago(self):
        ...
        self.assertEqual(notificar.call_args_list[0].args[1], 20)
        self.assertEqual(notificar.call_args_list[0].args[2], "subasta")
        self.assertIn("Ganaste", notificar.call_args_list[0].args[3])

        self.assertEqual(notificar.call_args_list[1].args[1], 30)
        self.assertEqual(notificar.call_args_list[1].args[2], "subasta")
        self.assertIn("vendio", notificar.call_args_list[1].args[3])
