# Trabajo Práctico Obligatorio — Sistema de Subastas

> **Materia:** Desarrollo de Aplicaciones I
> **Cuatrimestre:** Primer Cuatrimestre 2026
> **Tema:** Aplicaciones Distribuidas
> **Tipo:** Trabajo Práctico Obligatorio
> **(Origen de la consigna):** Segundo Cuatrimestre 2019
...
- El plano de despliegue de estos wireframes ([Figma](https://www.figma.com/)).
...
- Descripción de los endpoints del API Rest diseñado con sus correspondientes parámetros, retornos, códigos de retorno (200, 404, etc.), puede utilizar [Swagger](https://swagger.io/).
  - Referencia de códigos de estado HTTP: <https://www.iana.org/assignments/http-status-codes/http-status-codes.xhtml>
...
*La trazabilidad del diseño en la aplicación debe estar presente, no se aprobarán trabajos que definan un funcionamiento durante el diseño y terminen entregando un funcionamiento distinto al definido.*
